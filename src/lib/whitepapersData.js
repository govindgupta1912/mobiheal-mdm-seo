...
export const whitepapers = [
  {
    ...
    title:
      "Unlocking Business Potential: How Mobile Device Management Solutions Transform Operations",
    heroSubtitle:
      "Discover how Mobile Device Management solutions optimize operations, enhance security, and drive cost-efficiency.",
    heroImage: wp1,
    type: "Whitepaper",

    // ✅ SEO Fields
    seoTitle:
      "Unlocking Business Potential: How MDM Solutions Transform Operations | MobiHeal MDM",
    seoDescription:
      "Explore how MDM solutions can transform your business operations by enhancing security, ensuring compliance, and reducing costs. Learn about the benefits of MDM in various industries.",
    ...
    ogTitle:
      "Unlocking Business Potential: How MDM Solutions Transform Operations | MobiHeal MDM",
    ogDescription:
      "Discover how MobiHeal's MDM solutions can optimize operations, enhance security, and reduce costs across industries.",
    ogType: "article",
    ...
    twitterTitle:
      "Unlocking Business Potential: How MDM Solutions Transform Operations | MobiHeal MDM",
    twitterDescription:
      "Learn how MobiHeal's MDM solutions can enhance security, improve compliance, and drive cost-efficiency.",
    get twitterImage() {
      return this.ogImage;
    },
  ...
  },
  {
    ...
    heroSubtitle:
      "A deep dive into securing enterprise mobility across BFSI, defence, and education through advanced MDM strategies.",
    ...
    seoDescription:
      "Explore our Comprehensive Guide to Mobile Device Security. Learn best practices, strategies, and solutions to secure enterprise mobile devices efficiently.",
    ...
    ogDescription:
      "Master mobile device security with MobiHeal's comprehensive guide, covering compliance, BYOD security, kiosk mode, and advanced MDM strategies.",
    ogType: "article",
    ...
    twitterCard: "summary_large_image",
    twitterTitle:
      "Comprehensive Guide to Mobile Device Security | MobiHeal MDM",
    twitterDescription:
      "Discover how to secure enterprise mobility with MobiHeal's in-depth mobile device security guide — from compliance to kiosk mode.",
    get twitterImage() {
      return this.ogImage;
    },
    twitterSite: "@MobiHealMDM",
    ...
    pdfUrl:
      "/assets/whitepapers/pdf/Comprehensive Guide to Mobile Device Security.pdf",
    downloadForm: {
      enabled: true,
    },
  },
  {
    ...
    heroSubtitle:
      "Learn how to securely manage personal devices at work while boosting employee productivity and ensuring compliance.",
    heroImage: wp3, // Replace with actual import or image reference
    type: "Whitepaper",
    // ✅ SEO Fields
    seoTitle:
      "Best Practices for BYOD Implementation in Enterprises | MobiHeal MDM",
    seoDescription:
      "Discover proven strategies for secure BYOD implementation in enterprises. Learn how MobiHeal MDM ensures compliance, enhances productivity, and mitigates risks.",
    ...
    ogTitle:
      "Best Practices for BYOD Implementation in Enterprises | MobiHeal MDM",
    ogDescription:
      "Master BYOD security and compliance with MobiHeal's expert guide — covering risk mitigation, data separation, and policy enforcement.",
    ogType: "article",
    ...
    twitterTitle:
      "Best Practices for BYOD Implementation in Enterprises | MobiHeal MDM",
    twitterDescription:
      "Learn how to securely manage personal devices at work with MobiHeal's proven BYOD strategies — compliance, productivity, and risk reduction.",
    get twitterImage() {
      return this.ogImage;
    },
    twitterSite: "@MobiHealMDM",
  ...
  },
  {
    ...
    heroSubtitle:
      "Discover how MobiHeal’s unified MDM solution fortifies enterprise mobility, reduces costs, and future-proofs your digital ecosystem.",
    heroImage: wp4, // Replace with the actual image reference
    type: "Whitepaper",
    // ✅ SEO Fields
    seoTitle:
      "Advanced Mobile Device Management with MobiHeal: Secure, Scalable & Future-Ready | MobiHeal MDM",
    seoDescription:
      "Discover how MobiHeal’s next-gen Mobile Device Management solution fortifies security, optimizes costs, ensures compliance, and accelerates mobile workforce productivity for SMEs and enterprises alike.",
    ...
    ogTitle:
      "Advanced Mobile Device Management with MobiHeal: Secure, Scalable & Future-Ready | MobiHeal MDM",
    ogDescription:
      "MobiHeal’s advanced MDM secures devices, streamlines operations, and empowers enterprises to scale efficiently while meeting compliance.",
    ogType: "article",
    ...
    twitterTitle:
      "Advanced Mobile Device Management with MobiHeal: Secure, Scalable & Future-Ready | MobiHeal MDM",
    twitterDescription:
      "Explore how MobiHeal’s advanced MDM delivers security, compliance, cost efficiency, and growth for modern enterprises.",
    get twitterImage() {
      return this.ogImage;
    },
    twitterSite: "@MobiHealMDM",
