  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:title"
          content="Contact MobiHeal | Book a Demo or Speak with MDM Experts"
        />
        <meta
        ...
        <meta
          ...
          content="MobiHeal contact support team illustration"
        />
          ...
          <div className="lg:w-1/2 space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-neutral-600">
                  L-92, 2nd floor, Munirka, New Delhi - 110067
                  <br />
                  <br />
                  F-200, FF, Phase-I, New Palam Vihar, Sector 110, Gurugram –
                  122017
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            {[
              ...
              [
                "Discovery Call",
                "We'll understand your needs in a quick call.",
              ],
