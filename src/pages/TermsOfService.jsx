...
const TermsOfService = () => {
  return (
    <>  <Helmet>
        <title>Terms of Service | Mobisec Technologies Pvt. Ltd</title>
        <meta name="description" content="Read the legal terms and policies of Mobisec Technologies Pvt. Ltd including our privacy policy, user responsibilities, and service terms." />
        <meta name="keywords" content="terms of service, privacy policy, Mobisec Technologies, legal terms, conditions" />
        <meta name="author" content="Mobisec Technologies Pvt. Ltd " />
      </Helmet>
      ...
      <article className="space-y-10 leading-relaxed text-lg text-gray-700">
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Agreement to Our Legal Terms</h2>
          <p className="mb-4">
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Table of Contents</h2>
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Our Services</h2>
          <p>
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Intellectual Property Rights</h2>

          <h3 className="text-2xl font-semibold  mb-3">Our intellectual property</h3>
          <p className="mb-4">
          ...
          <h3 className="text-2xl font-semibold  mt-6 mb-3">Your use of our Services</h3>
          <p className="mb-4">
          ...
          <h3 className="text-2xl font-semibold  mt-6 mb-3">Your submissions</h3>
          <p className="mb-4">
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">User Representations</h2>
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">User Registration</h2>
          <p>
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Purchases and Payment</h2>
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Free Trial</h2>
          <p>
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Cancellation</h2>
          <p className="mb-4">
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Prohibited Activities</h2>
          <p className="mb-4">
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">User Generated Contributions</h2>
          <p className="mb-4">
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Contribution License</h2>
          <p className="mb-4">
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Services Management</h2>
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Privacy Policy</h2>
          <p className="mb-4">
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Term and Termination</h2>
          <p className="mb-4">
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Modifications and Interruptions</h2>
          <p className="mb-4">
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Governing Law</h2>
          <p>
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Dispute Resolution</h2>
          <p>
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Corrections</h2>
          <p>
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Disclaimer</h2>
          <p className="mb-4">
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Limitations of Liability</h2>
          <p>
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Indemnification</h2>
          <p className="mb-4">
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">User Data</h2>
          <p>
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Electronic Communications, Transactions, And Signatures</h2>
          <p className="mb-4">
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          <h2 className="text-3xl font-bold  mb-6 border-b-2 border-primary-light pb-2">Miscellaneous</h2>
          <p>
