  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Read the legal terms and policies of Mobisec Technologies Pvt. Ltd including our privacy policy, user responsibilities, and service terms."
        />
        <meta
          name="keywords"
          content="terms of service, privacy policy, Mobisec Technologies, legal terms, conditions"
        />
      ...
      <div className="bg-white text-gray-900 font-serif min-h-screen py-12 px-4 sm:px-8 md:px-12 lg:px-20">
        <div className="flex flex-col md:flex-row gap-8 max-w-7xl mx-auto">
          {/* Sidebar */}
          <aside className="w-full md:w-1/4 border-r border-gray-300 pr-4 mb-8 md:mb-0">
          ...
          <main className="flex-1 max-w-4xl">
            ...
            <article className="space-y-10 leading-7 text-justify">
              <section>
                <h2 className="text-xl font-semibold mt-6 mb-4">
                  Agreement to Our Legal Terms
                </h2>
                <p className="mb-4">
                  We are <strong>Mobisec Technologies Pvt. Ltd</strong>
                  ("Company," "we," "us," "our"), a company registered in India at
                  F-200, FF, Phase-1, New Palam Vihar, Sec-110, Gurugram,
                  Haryana 122017.
                </p>
                <p className="mb-4">
                  We operate the website{" "}
                  <a
                    href="https://mobiheal.in"
                ...
                <p className="mb-4">
                  ...
                  , or by mail to F-200, FF, Phase-1, New Palam Vihar, Sec-110,
                  Gurugram, Haryana 122017, India.
                </p>
                <p className="mb-4">
                  These Legal Terms constitute a legally binding agreement made
                  between you, whether personally or on behalf of an entity
                  ("you"), and <strong>Mobisec Technologies Pvt. Ltd</strong>,
                  ...
                  Users will be notified of any changes to our Legal Terms through
                  our website.
                </p>
                <p className="mb-4">
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 pl-4 mb-4">
                  ...
                  <li>
                    ...
                    you have properly gained access solely for your internal business
                    purpose.
                  </li>
                </ul>
                <p className="mb-4">
                ...
                <h3 className="text-lg font-semibold mt-6 mb-2">Your submissions</h3>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-xl font-semibold mt-6 mb-4">User Representations</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold mt-6 mb-4">Purchases and Payment</h2>
                ...
                <p className="mb-4">
                  ...
                  information for all purchases made via the Services. You further agree
              ...
              <section>
                <h2 className="text-xl font-semibold mt-6 mb-4">Free Trial</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-semibold mt-6 mb-4">Cancellation</h2>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-xl font-semibold mt-6 mb-4">Contribution License</h2>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-xl font-semibold mt-6 mb-4">Services Management</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold mt-6 mb-4">Privacy Policy</h2>
                <p className="mb-4">
                  We care about data privacy and security. Please review our Privacy
                  Policy:{" "}
                  <a
                    href="https://mobiheal.in/privacy_policy/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-700 hover:underline"
                  >
                    https://mobiheal.in/privacy_policy/
                  </a>{" "}
              ...
              <section>
                <h2 className="text-xl font-semibold mt-6 mb-4">Term and Termination</h2>
                <p className="mb-4">
              ...
              <section>
                ...
                <p>
                  ...
                  India. **Mobisec Technologies Pvt. Ltd** and yourself irrevocably
              ...
              <section>
                <h2 className="text-xl font-semibold mt-6 mb-4">Dispute Resolution</h2>
                <p>
                  ...
                  jurisdiction of the India courts. **Mobisec Technologies Pvt. Ltd**
                  shall also maintain the right to bring proceedings as to the substance
                  of the matter in the courts of the country where you reside or, if
              ...
              <section>
                <h2 className="text-xl font-semibold mt-6 mb-4">Corrections</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-semibold mt-6 mb-4">Disclaimer</h2>
                <p className="mb-4">
              ...
              <section>
                ...
                <p>
                  ...
                  if any, by you to us during the six (6) month period prior to any cause
                  of action arising. Certain state laws and international laws do not
              ...
              <section>
                <h2 className="text-xl font-semibold mt-6 mb-4">Indemnification</h2>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-xl font-semibold mt-6 mb-4">User Data</h2>
                <p>
              ...
              <section>
                ...
                <p>
                  ...
                  or liable for any loss, damage, delay, or failure to act caused by any
                  ...
                  employment or agency relationship created between you and us as a result
                  of these Legal Terms or use of the Services. You agree that these Legal
                  Terms will not be construed against us by virtue of having drafted them.
