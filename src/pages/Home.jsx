...
const Home = () => {
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        installUrl:
          "https://play.google.com/store/apps/details?id=com.mobiheal.buddy",
        publisher: { "@id": `${siteUrl}/#organization` },
        offers: [
          {
            "@type": "Offer",
  ...
  return (
    <>
      <Helmet>
        <title>
          MobiHeal MDM | Unified Mobile Device Management & Security
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="MobiHeal MDM | Unified Mobile Device Management & Security"
        />
        <meta
        ...
        <meta
          ...
          content="MobiHeal MDM dashboard preview"
        />
