      ...
      <div className="flex flex-col md:flex-row gap-8 max-w-7xl mx-auto">
        ...
        <aside className="w-full md:w-1/4 border-r border-gray-300 pr-4">
          ...
          <nav className="space-y-2">
            <Link to="/cookies-policy" className="block text-blue-700 hover:underline">
              Cookies Policy
            </Link>
            ...
            <Link to="/acceptable-use-policy" className="block text-blue-700 font-medium underline">
        ...
        <main className="flex-1 max-w-4xl">
          ...
          <article className="space-y-6 leading-7 text-justify">
            ...
            <p>
              We are <strong>Mobisec Technologies Pvt. Ltd</strong> ("Company," "we," "us," or "our") a company registered in India at F-200, FF, Phase-1, New Palam Vihar, Sec-110, Gurugram, Haryana 122017.
            </p>
            <p>
              We operate the website (the "Site"), as well as any other related products and services that refer or link to this Policy (collectively, the "Services").
            </p>
            ...
            <ul className="list-disc list-inside space-y-1">
              <li>Engage in any use, including modification, copying, redistribution, publication, display, performance, or retransmission, of any portions of any Services, other than as expressly permitted by this Policy, without the prior written consent of Mobisec Technologies Pvt. Ltd, which consent Mobisec Technologies Pvt. Ltd may grant or refuse in its sole and absolute discretion.</li>
              ...
              <li>Do not share login credentials with unauthorized entities.</li>
            </ul>

            <h2 className="text-xl font-semibold mt-6">Consequences of breaching this policy</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold mt-6">How can you contact us about this policy?</h2>
            <p>If you have any further questions or comments, you may contact us by:</p>
            <ul className="list-disc list-inside">
              <li>Phone: +91-11-6926-8029</li>
              <li>Email: contact@mobisec.in</li>
            </ul>
          </article>
        </main>
      </div>
