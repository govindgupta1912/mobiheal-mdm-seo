          ...
          <article className="space-y-6 leading-7 text-justify">
            ...
            <ul className="list-disc list-inside space-y-1">
              <li>
                ...
                <em>Mobisec Technologies Pvt. Ltd</em>, F-200, FF, Phase-1, New
                Palam Vihar, Sec-110, Gurugram, Haryana-122017, India.
              </li>
              <li>
                <strong>Cookies</strong> means small files that are placed on
                your computer, mobile device or any other device by a website,
                containing details of your browse history on that website among
                its many uses.
              </li>
              <li>
                <strong>Website</strong> refers to Mobiheal website, accessible
                from{" "}
                <a
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>
                Other browsers: Please visit your web browser's official web
                pages.
              </li>
            </ul>
            ...
            <p>
              ...
              <a
                href="https://www.privacypolicies.com/blog/cookies-what-do-they-do/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-primary hover:underline"
              >
