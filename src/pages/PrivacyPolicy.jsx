  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-indigo-100 text-gray-800 font-sans min-h-screen py-16 px-4 sm:px-8 md:px-12 lg:px-20 max-w-6xl mx-auto shadow-lg rounded-xl my-8">
      ...
      <article className="space-y-10 leading-relaxed text-lg text-gray-700">
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          ...
          <ul className="list-disc list-inside space-y-2 pl-4">
            ...
            <li><strong>Website</strong> refers to mobiheal.in, accessible from <a href="https://mobiheal.in" className="text-blue-600 hover:text-blue-800 underline transition-colors duration-200">https://mobiheal.in</a></li>
            <li><strong>App</strong> refers to MobiHeal Buddy app, accessible from <a href="https://play.google.com/store/apps/details?id=com.mobiheal.buddy" className="text-blue-600 hover:text-blue-800 underline transition-colors duration-200">Google Play</a></li>
        ...
        <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          ...
          <p className="mt-4">The app does use third-party services that may collect information used to identify you. Link to the privacy policy of third-party service providers used by the app:</p>
          <ul className="list-disc list-inside mt-2 pl-4">
            <li><a href="https://www.google.com/policies/privacy/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline transition-colors duration-200">Google Play Services</a></li>
            <li><a href="https://firebase.google.com/support/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline transition-colors duration-200">Google Analytics for Firebase</a></li>
            <li><a href="https://firebase.google.com/support/privacy/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline transition-colors duration-200">Firebase Crashlytics</a></li>
          </ul>

          <h4 className="text-xl font-medium text-primary mt-6 mb-2">Usage Data</h4>
      ...
      <section className="p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
          ...
          <p className="mt-6 mb-4">Cookies can be "Persistent" or "Session" cookies. Persistent cookies remain on your personal computer or mobile device when you go offline, while Session cookies are deleted as soon as you close your web browser. Learn more about cookies on the Free Privacy Policy website article.</p>
          ...
          <p className="mt-6">For more information about the cookies we use and your choices regarding cookies, please visit our cookies policy or the cookies section of our Privacy Policy.</p>
        </section>
