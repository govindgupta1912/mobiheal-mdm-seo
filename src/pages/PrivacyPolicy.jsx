      ...
      <div className="flex flex-col md:flex-row gap-8 max-w-7xl mx-auto">
        ...
        <main className="flex-1 max-w-4xl">
          ...
          <article className="space-y-10 leading-7 text-justify">
            {/* --- Content from original PrivacyPolicy.jsx --- */}
            <section>
              <p className="mb-4">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 pl-4">
                ...
                <li>
                  ...
                  <em>Mobisec Technologies Pvt. Ltd.</em>, F-200, FF, Phase-I,
                  New Palam Vihar, Sector -110, Gurugram-122017, Haryana, IN.
                </li>
                <li>
                ...
                <li>
                  ...
                  Service such as a computer, a smartphone or a digital tablet.
                </li>
                <li>
                ...
                <li>
                  <strong>Service</strong> refers to the website and Buddy app.
                </li>
                <li>
                ...
                <li>
                  ...
                  duration of a page visit or use of Buddy app).
                </li>
                <li>
                  <strong>Website</strong> refers to mobiheal.in, accessible
                  from{" "}
                  <a
                ...
                <li>
                  <strong>App</strong> refers to MobiHeal Buddy app, accessible
                  from{" "}
                  <a
                    href="https://play.google.com/store/apps/details?id=com.mobiheal.buddy"
                    className="text-primary hover:underline"
                  >
                    Google Play
                  </a>
            ...
            <section>
              ...
              <h4 className="text-base font-semibold text-primary mt-4 mb-2">
                Usage Data
              </h4>
              <p>
            ...
            <section>
              ...
              <ul className="list-disc list-inside pl-4 mb-2">
                ...
                <li>
                  ...
                  <br />
                  <span className="font-semibold">Type:</span> Persistent
                  Cookies
                  <br />
                  <span className="font-semibold">Administered by:</span> us
                  <br />
            ...
            <section>
              ...
              <ul className="list-disc list-inside pl-4 mb-2">
                <li>
                  ...
                  personal information with Service Providers such as Google
                  Play Services and Firebase to monitor and analyze the use of
