      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-neutral-600 max-w-3xl mx-auto">
            MobiHeal MDM solution adapts to multiple deployment scenarios across
            various industries.
          </p>
        </div>
        ...
        <Tabs defaultValue="kiosk" className="w-full" onValueChange={setActiveTab}>
          ...
          <TabsContent
            value={activeTab}
            className="mt-0 animate-fade-in transition-opacity duration-500"
          >
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="md:w-1/2">
                ...
                <p className="text-neutral-600 mb-6">{activeCase.description}</p>
